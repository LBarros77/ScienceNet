...
gulp.task('scss', function () {
    return gulp.src([paths.src.scss + '/bootstrap/**/*.scss', paths.src.scss + '/front/**/*.scss', paths.src.scss + '/front.scss'])
        .pipe(wait(500))
...
gulp.task('serve', gulp.series('scss', 'html', 'index', 'assets', 'vendor', function() {
    ...
    gulp.watch([paths.src.scss + '/bootstrap/**/*.scss', paths.src.scss + '/front/**/*.scss', paths.src.scss + '/front.scss'], gulp.series('scss'));
